...
#               Set ping command and parse regex per o/s for 
#                Windows, Cygwin, and Ubuntu (Raspberry Pi).  
#               (Still need to find a cheap way to get the IP4
#                address of the gateway.)
#               Remove dependency on f-string {varname=}, which doesn't 
#                run on my old Raspbian that I am not inclined to 
#                upgrade, grumble.  
# 
# 
